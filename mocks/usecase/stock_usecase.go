...
func (_m *StockUsecase) CreateStock(stock *domain.Stock) error {
	ret := _m.Called(stock)
...
func (_m *StockUsecase) DeleteStock(id int) error {
	ret := _m.Called(id)
...
func (_m *StockUsecase) GetAllStock() []domain.Stock {
	ret := _m.Called()
...
func (_m *StockUsecase) GetStockByID(id int) (*domain.Stock, error) {
	ret := _m.Called(id)
...
func (_m *StockUsecase) UpdateStock(stock *domain.Stock) error {
	ret := _m.Called(stock)
...
func NewStockUsecase(t interface {
	mock.TestingT
	Cleanup(func())
}) *StockUsecase {
	mock := &StockUsecase{}
